document.addEventListener("DOMContentLoaded", () => {
  ...
  async function loadStats() {
    try {
      const res  = await fetch("https://adviceme-production.up.railway.app/api/badge/calculate", { headers: { Authorization: `Bearer ${token}` } });
  ...
  showBtn.onclick = async () => {
    ...
    try {
      const res  = await fetch(
        `https://adviceme-production.up.railway.app/api/requests/category/${encodeURIComponent(category)}`,
  ...
  removeBtn.onclick = async () => {
    ...
    await fetch(
      `https://adviceme-production.up.railway.app/api/requests/remove/${activePerson.dataset.track}`,
  ...
  respondBtn.onclick = async () => {
    ...
    try {
      const res = await fetch("https://adviceme-production.up.railway.app/api/advice/respond", {
        method: "POST",
  ...
  viewProfileBtn.onclick = async () => {
    ...
    try {
      const [profileRes, badgeRes] = await Promise.all([
        fetch("https://adviceme-production.up.railway.app/api/profile/me",      { headers: { Authorization: `Bearer ${token}` } }),
        fetch("https://adviceme-production.up.railway.app/api/badge/calculate", { headers: { Authorization: `Bearer ${token}` } })
      ]);
  ...
  function renderProfileEdit(data, badgeData) {
    ...
    document.getElementById("saveEditBtn").onclick = async () => {
      ...
      const resUpdate = await fetch("https://adviceme-production.up.railway.app/api/profile/update", {
  ...
  if (chatBtn) {
    chatBtn.onclick = async () => {
      try {
        const res   = await fetch("https://adviceme-production.up.railway.app/api/chat/list", { headers: { Authorization: `Bearer ${token}` } });
