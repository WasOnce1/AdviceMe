...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    const res = await fetch("https://adviceme-production.up.railway.app/api/profile/me", {
...
form.addEventListener("submit", async (e) => {
  ...
  try {
    const res = await fetch("https://adviceme-production.up.railway.app/api/profile/create", {
      method: "POST",
      headers: { Authorization: `Bearer ${token}` },
      body: formData
    });
